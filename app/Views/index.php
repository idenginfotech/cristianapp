        ...
        <div class="hero-right-scmm" style="padding : 20px;">
          <div class="hero-service-cards wow fadeInRight" data-wow-duration="2s">
            <div class="owl-carousel service-card-prb">
              ...
              <?php
              $service_card_loop = [
                array("background"=>"card-bg-a", "title"=>"<span>Mobile</span> Applications", "image"=>"app-develop.png"),
                 array("background"=>"card-bg-b", "title"=>"<span>Web</span> Development", "image"=>"web_dev.png"),
                 array("background"=>"card-bg-c", "title"=>"<span>Business</span> Automation", "image"=>"automation.png"),
                 array("background"=>"card-bg-d", "title"=>"<span>Web</span> Hosting", "image"=>"webhost.png"),
                ...
                <a href="service">
                  <div class="service-card-hh">
                    <div class="image-sr-mm">
                      <img alt="custom-sport" src="public/assets/images/service/<?php echo $value["image"];?>">
                    </div>
